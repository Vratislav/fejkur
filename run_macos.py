...
class MacOSVoiceRecognizer:
    ...
    def __init__(self):
        ...
        self.logger.info("MacOS Voice Recognizer initialized")
    ...
    def setup_logging(self):
        ...
        logging.basicConfig(
            ...
            handlers=[
                ...
                logging.FileHandler('voice-recognizer-macos.log')
            ]
        )
    ...
    def initialize(self):
        ...
        try:
            self.logger.info("Initializing MacOS Voice Recognizer...")
            ...
            self.logger.info("MacOS Voice Recognizer initialized successfully")
            return True
    ...
    def shutdown(self):
        """Shutdown the system"""
        self.logger.info("Shutting down MacOS Voice Recognizer...")
        self.running = False
...
def main():
    ...
    if not recognizer.initialize():
        print("Failed to initialize voice recognizer")
        sys.exit(1)
